...
<div class="mainwrapper fullwrapper">
    ...
    <div class="leftpanel">
        ...
        <div class="logopanel">
        	<h1><a href="dashboard.php">Badooy Studio</a></h1>
        </div><!--logopanel-->
    ...
    <div class="rightpanel">
		...
		<div class="pagetitle">
        	<h1>PERANCANGAN SISTEM INVENTORY BADOOY STUDIO</h1> <!--<span>This is a sample description for dashboard page...</span>-->
        </div><!--pagetitle-->
